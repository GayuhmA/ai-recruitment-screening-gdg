...
export function useCreateApplication() {
  ...
  return useMutation({
    mutationFn: ({ jobId, data }: { jobId: string; data: CreateApplicationRequest }) =>
...
export function useUpdateApplication() {
  ...
  return useMutation({
    mutationFn: ({ applicationId, data }: { applicationId: string; data: UpdateApplicationRequest }) =>
...
export function useDeleteApplication() {
  ...
  return useMutation({
    mutationFn: (applicationId: string) => api.applications.delete(applicationId),
